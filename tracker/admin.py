...
class TrackerAccountAdmin(admin.ModelAdmin):
    list_display = ("id", "telegram_id", "api_id", "is_active", "is_auth", "created_at", "updated_at")
    list_filter = ("is_active", "is_auth", "created_at")
    search_fields = ("telegram_id", "api_id")
...
class TrackerSettingAdmin(admin.ModelAdmin):
    ...
    search_fields = ("phone_number", "tracker_account__telegram_id")


@admin.register(TelegramUser)
class TelegramUserAdmin(admin.ModelAdmin):
    list_display = ("id", "telegram_id", "role", "created_at", "updated_at", "max_users", "current_users")
...
class TrackedUserAdmin(admin.ModelAdmin):
    ...
    search_fields = ("username", "telegram_user__telegram_id")
...
class OnlineStatusAdmin(admin.ModelAdmin):
    ...
    search_fields = ("tracked_user__username", "tracked_user__telegram_user__telegram_id")
